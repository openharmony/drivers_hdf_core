...
void DmaCntlrDestroy(const struct DmaCntlr *cntlr);

int32_t DmacCntlrAdd(const struct DmaCntlr *cntlr);

void DmacCntlrRemove(const struct DmaCntlr *cntlr);

int32_t DmaCntlrTransfer(const struct DmaCntlr *cntlr, const struct DmacMsg *msg);

uintptr_t DmaGetCurrChanDestAddr(const struct DmaCntlr *cntlr, uint16_t chan);
#else
...
static inline void DmaCntlrDestroy(const struct DmaCntlr *cntlr)
{
    (void)cntlr;
    return;
}

static inline int32_t DmacCntlrAdd(const struct DmaCntlr *cntlr)
{
    (void)cntlr;
    return HDF_ERR_NOT_SUPPORT;
}

static inline void DmacCntlrRemove(const struct DmaCntlr *cntlr)
{
    (void)cntlr;
    return;
}

static inline int32_t DmaCntlrTransfer(const struct DmaCntlr *cntlr, const struct DmacMsg *msg)
{
    (void)cntlr;
    (void)msg;
    return HDF_ERR_NOT_SUPPORT;
...
static inline uintptr_t DmaGetCurrChanDestAddr(const struct DmaCntlr *cntlr, uint16_t chan)
{
    (void)cntlr;
    (void)chan;
    return 0;
