    ...
    const String &gotoLabel, StringBuilder &sb, const String &prefix) const
{
    ...
    elementType_->EmitCWriteVar(parcelName, elementName, ecName.string(), gotoLabel, sb, prefix + TAB);
    sb.Append(prefix).Append("}\n");
}
...
void ASTListType::EmitCStubReadOutVar(const String &buffSizeName, const String &memFlagName, const String &parcelName,
...
void ASTListType::EmitCppWriteVar(const String &parcelName, const String &name, StringBuilder &sb, const String &prefix,
...
void ASTListType::EmitCppReadVar(const String &parcelName, const String &name, StringBuilder &sb, const String &prefix,
