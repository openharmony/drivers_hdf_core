...
void *AudioUsbFindDesc(void *descStart, int32_t descLen, const void *after, uint8_t dtype);
void *AudioUsbFindCsintDesc(void *buf, int32_t bufLen, const void *after, uint8_t dsubType);
